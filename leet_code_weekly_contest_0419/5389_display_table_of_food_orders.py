"""
5389. Display Table of Food Orders in a RestaurantMy SubmissionsBack to Contest
User Accepted:874
User Tried:962
Total Accepted:876
Total Submissions:1246
Difficulty:Medium
...
class Solution:
    ...
    def displayTable(self, orders):
        ...
        header = ['Table'] + sorted(list(items))
        ret = [header]
